...
const techCirclesIdeaHub = [
  <TechCircle image="src/assets/icons/next-js.svg" key="nextjs" />,
  <TechCircle image="src/assets/icons/react.svg" key="react" />,
  <TechCircle image="src/assets/icons/typescript.svg" key="typescript" />,
  <TechCircle image="src/assets/icons/mongodb.svg" key="mongodb" />,
  <TechCircle image="src/assets/icons/tailwind.svg" key="tailwind" />,
];
...
const techCirclesDashForge = [
  <TechCircle image="src/assets/icons/react.svg" key="react" />,
  <TechCircle image="src/assets/icons/mongodb.svg" key="mongodb" />,
  <TechCircle image="src/assets/icons/javascript.svg" key="javascript" />,
  <TechCircle image="src/assets/icons/tailwind.svg" key="tailwind" />,
];
...
const techCirclesTodo = [
  <TechCircle image="src/assets/icons/next-js.svg" key="next-js" />,
  <TechCircle image="src/assets/icons/react.svg" key="react" />,
  <TechCircle image="src/assets/icons/mongodb.svg" key="mongodb" />,
  <TechCircle image="src/assets/icons/typescript.svg" key="typescript" />,
  <TechCircle image="src/assets/icons/tailwind.svg" key="tailwind" />,
    ...
    <section id="projects" className="gradient-image border-t border-gray-500">
      <div className="px-6 py-12 flex flex-col justify-center items-center gap-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          />
          <ProjectCard
            image="src/assets/kanban-buddy.png"
            title="Kanban Buddy"
          ...
          />
          <ProjectCard
            image="src/assets/dashforge.png"
            title="DashForge"
          ...
          />
          <ProjectCard
            image="src/assets/codelanginsights.png"
          ...
          />
          <ProjectCard
            image="src/assets/wanderway.png"
          ...
          />
          <ProjectCard
            image="src/assets/gemini-clone.png"
            title="Gemini Clone"
