...
const techCirclesIdeaHub = [
  ...
  <TechCircle image="public\icons\react.svg" key="react" />,
  <TechCircle image="public\icons\mongodb.svg" key="mongodb" />,
  <TechCircle image="public\icons\typescript.svg" key="typescript" />,
  <TechCircle image="public\icons\tailwind.svg" key="tailwind" />,
];
...
const techCirclesDashForge = [
  <TechCircle image="public\icons\react.svg" key="react" />,
  <TechCircle image="public\icons\mongodb.svg" key="mongodb" />,
  <TechCircle image="public\icons\javascript.svg" key="javascript" />,
  <TechCircle image="public\icons\tailwind.svg" key="tailwind" />,
];
    ...
    <section id="projects" className="gradient-image border-t border-gray-500">
      <div className="px-6 py-12 flex flex-col justify-center items-center gap-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <ProjectCard
            image="public\images\ideahub.png"
            title="IdeaHub"
          ...
          />
          <ProjectCard
            image="public\images\kanban-buddy.png"
            title="Kanban Buddy"
          ...
          />
          <ProjectCard
            image="public\images\dashforge.png"
            title="DashForge"
          ...
          />
          <ProjectCard
            image="public\images\codelanginsights.png"
          ...
          />
          <ProjectCard
            image="public\images\wanderway.png"
          ...
          />
          <ProjectCard
            image="public\images\gemini-clone.png"
            title="Gemini Clone"
